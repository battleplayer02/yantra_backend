!function (t, e) {
    ...
    function ft(t) {
        vn.isVisible() && gt !== t.target.value && vn.resetValidationMessage(), gt = t.target.value
    }
    ...
    var gt, vt = function (t, e) {
        ...
        kt = function (t) {
            var e, n, o, i, r, a, c, s, u, l, d, p, f, m, h,
                g = !!(e = J()) && (e.parentNode.removeChild(e), yt([document.documentElement, document.body], [Q["no-backdrop"], Q["toast-shown"], Q["has-column"]]), !0);
    ...
    function Vt(t, e) {
        ...
        }), o.input && (a && Lt(o), jt(o)), _(B(), e, "content")
    }
    ...
    function Rt(t, e) {
        var n, o, i, r, a, c, s, u, l = j();
        _(l, e, "header"), Ht(0, e), n = t, o = e, (r = Ot.innerParams.get(n)) && o.icon === r.icon && k() ? Ft(k(), o) : (_t(), o.icon && (-1 !== Object.keys($).indexOf(o.icon) ? (i = C(".".concat(Q.icon, ".").concat($[o.icon])), rt(i), Wt(i, o), Ft(i, o), vt(i, o.showClass.icon)) : W('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(o.icon, '"')))), function (t) {
            var e = P();
    ...
    function Nt(t, e) {
        var n, o, i, r;
        n = e, o = X(), it(o, "width", n.width), it(o, "padding", n.padding), n.background && (o.style.background = n.background), Qt(o, n), St(0, e), Rt(t, e), Vt(t, e), ht(0, e), i = e, r = I(), st(r, i.footer), i.footer && mt(i.footer, r), _(r, i, "footer"), "function" == typeof e.onRender && e.onRender(X())
    }
    ...
    function ne(t) {
        for (var e in t) te(i = e) || z('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== ce.indexOf(o) && z('The parameter "'.concat(o, '" is incompatible with toasts'))), ee(n = e) && g(n, ee(n));
        var n, o, i
    }
    ...
    var oe = {}, ie = {
            ...
            toast: !1,
            animation: !!0,
            showClass: {popup: /*"swal2-show"*/"swal2-noanimation", backdrop: "swal2-backdrop-show", icon: "swal2-icon-show"},
        ...
        ae = {animation: 'showClass" and "hideClass'},
        ce = ["allowOutsideClick", "allowEnterKey", "backdrop", "focusConfirm", "focusDeny", "focusCancel", "heightAuto", "keydownListenerCapture"],
        se = Object.freeze({
            isValidParameter: te,
    ...
    function ye(t) {
        ...
        }(t), (e = Ot.innerParams.get(this)) && !U(i, e.hideClass.popup) && (n = ge.swalPromiseResolve.get(this), yt(i, e.showClass.popup), vt(i, e.hideClass.popup), o = J(), yt(o, e.showClass.backdrop), vt(o, e.hideClass.backdrop), function (t, e, n) {
            var o = J(), i = Pt && lt(e), r = n.onClose, a = n.onAfterClose;
    ...
    function Ae(t) {
        ...
        He(e, n, t), Ve(e, n), H() && (De(e, t.scrollbarPadding, o), h(document.body.children).forEach(function (t) {
            t === J() || function (t, e) {
        ...
        })), G() || oe.previousActiveElement || (oe.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function () {
            return t.onOpen(n)
    ...
    function Se(t) {
        var e, n = X();
        t.target === n && (e = J(), n.removeEventListener(Pt, Se), e.style.overflowY = "auto")
    }

    function Ee(t, e) {
        "select" === e.input || "radio" === e.input ? _e(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && (v(e.inputValue) || b(e.inputValue)) && Fe(t, e)
    }

    function Oe(t, e) {
        t.disableButtons(), e.input ? Ke(t, e) : Ze(t, e, !0)
    }

    function Te(t) {
        t.disableButtons(), Ye(t)
    }
    ...
    function Me(t, e, n) {
        Ot.innerParams.get(t).toast ? on(t, e, n) : (an(e), cn(e), sn(t, e, n))
    }

    var Ve = function (t, e) {
            Pt && lt(e) ? (t.style.overflowY = "hidden", e.addEventListener(Pt, Se)) : t.style.overflowY = "auto"
        }, De = function (t, e, n) {
            var o;
            ...
            n.inputValidator ? (e.disableInput(), Promise.resolve().then(function () {
                ...
                e.enableButtons(), e.enableInput(), t ? e.showValidationMessage(t) : Ze(e, n, o)
            })) : e.getInput().checkValidity() ? Ze(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
        }, Ye = function (t) {
            ...
            t.showLoaderOnConfirm && $t(), t.preConfirm ? (e.resetValidationMessage(), Promise.resolve().then(function () {
                ...
                wt(S()) || !1 === t ? e.hideLoading() : qe(e, void 0 === t ? n : t)
            })) : qe(e, n)
        }, Qe = ["ArrowRight", "ArrowDown", "Right", "Down"], $e = ["ArrowLeft", "ArrowUp", "Left", "Up"],
        Je = ["Escape", "Esc"], Xe = function (t, e, n) {
            var o = Ot.innerParams.get(t);
            o.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? Ge(t, e, o) : "Tab" === e.key ? tn(e, o) : -1 !== [].concat(Qe, $e).indexOf(e.key) ? en(e.key) : -1 !== Je.indexOf(e.key) && nn(e, o, n)
        }, Ge = function (t, e, n) {
            ...
            var e, n;
            -1 !== [E(), O(), L()].indexOf(document.activeElement) && (e = -1 !== Qe.indexOf(t) ? "nextElementSibling" : "previousElementSibling", (n = document.activeElement[e]) && n.focus())
        }, nn = function (t, e, n) {
            ...
            e.popup.onmousedown = function () {
                e.container.onmouseup = function (t) {
                    e.container.onmouseup = void 0, t.target === e.container && (rn = !0)
                }
            }
        }, cn = function (e) {
            e.container.onmousedown = function () {
                e.popup.onmouseup = function (t) {
                    e.popup.onmouseup = void 0, t.target !== e.popup && !e.popup.contains(t.target) || (rn = !0)
                }
            }
        }, sn = function (n, o, i) {
            o.container.onclick = function (t) {
                var e = Ot.innerParams.get(n);
                rn ? rn = !1 : t.target === o.container && Y(e.allowOutsideClick) && i(Z.backdrop)
            }
        };
    var un = function (t, e, n) {
        var o = M();
        at(o), e.timer && (t.timeout = new xe(function () {
            n("timer"), delete t.timeout
        }, e.timer), e.timerProgressBar && (rt(o), setTimeout(function () {
            t.timeout.running && dt(e.timer)
        })))
    }, ln = function (t, e) {
        if (!e.toast) return Y(e.allowEnterKey) ? void(dn(t, e) || Ie(0, -1, 1)) : pn()
    }, dn = function (t, e) {
    ...
    var fn, mn = function (t) {
        ...
        hideLoading: ue, disableLoading: ue, getInput: function (t) {
            ...
            return ke(this.getInput(), !1)
        }, disableInput: function () {
            return ke(this.getInput(), !0)
            ...
            var e = function (t) {
                var e = s({}, ie.showClass, t.showClass), n = s({}, ie.hideClass, t.hideClass), o = s({}, ie, t);
            ...
            Object.keys(e).forEach(function (t) {
                vn.isUpdatableParameter(t) ? o[t] = e[t] : z('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
            });
            var i = s({}, n, o);
            ...
            e && (t.popup && oe.swalCloseEventFinishedCallback && (oe.swalCloseEventFinishedCallback(), delete oe.swalCloseEventFinishedCallback), oe.deferDisposalTimer && (clearTimeout(oe.deferDisposalTimer), delete oe.deferDisposalTimer), "function" == typeof e.onDestroy && e.onDestroy(), delete this.params, delete oe.keydownHandler, delete oe.keydownTarget, mn(Ot), mn(ge))
        }
    }), gn = function () {
        function r() {
            if (a(this, r), "undefined" != typeof window) {
                "undefined" == typeof Promise && W("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), fn = this;
                for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
    ...
    s(gn.prototype, hn), s(gn, se), Object.keys(hn).forEach(function (t) {
        gn[t] = function () {
            if (fn) return fn[t].apply(fn, arguments)
        }
    }), gn.DismissReason = Z, gn.version = "10.2.0";
    var vn = gn;
