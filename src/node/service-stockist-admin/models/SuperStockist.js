 ...
 * ==========
 */
const SuperStockist = new keystone.List('SuperStockist', {track: true});
 ...
 * Registration
 */
SuperStockist.defaultColumns = 'name, isActive, game, operator, credits, updatedAt, updatedBy';
SuperStockist.register();

const ThisModel = SuperStockist;
