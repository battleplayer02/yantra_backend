...
//Constants
var NUMBER_OF_WORKERS_PER_CPU = parseFloat(process.env.NUM_WORKERS || 0) || 1;

//Create the Sub cluster launcher
var localAppCluster = new LocalAppCluster(NUMBER_OF_WORKERS_PER_CPU, './app.js', "YANTRA" + (process.env.NODE_ENV || 'dev'));
//Launch sub cluster
